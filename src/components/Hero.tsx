...
export function Hero() {
  return (
    <>
      ...
      {/* Trusted By Banner - Full Width Dark Banner */}
      <div className="w-full bg-brand-dark py-6 animate-fade-in" style={{ animationDelay: "0.4s" }}>
        <div className="container-custom">
          <p className="text-center text-primary-foreground font-semibold text-lg tracking-wide">
            Trusted by
          </p>
        </div>
      </div>
