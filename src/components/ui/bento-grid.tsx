...
const BentoCard = ({
  ...
  <div
    key={name}
    className={cn(
      "group relative col-span-1 md:col-span-1 flex flex-col justify-between overflow-hidden rounded-xl min-h-[280px]",
      "bg-card [box-shadow:0_0_0_1px_rgba(0,0,0,.03),0_2px_4px_rgba(0,0,0,.05),0_12px_24px_rgba(0,0,0,.05)]",
      "transform-gpu transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-primary/5",
  ...
  >
    ...
    <div className="pointer-events-none absolute inset-0 transform-gpu transition-all duration-300 group-hover:bg-primary/[.02] group-hover:dark:bg-neutral-800/10" />
  </div>
);
